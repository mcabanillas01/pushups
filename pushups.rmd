...
position is categorical variable
we will load the num~cat

$H_0$ The null hypothesis there is no difference in the average number of pushups players can do in te=wo minutes based on the position they play.
